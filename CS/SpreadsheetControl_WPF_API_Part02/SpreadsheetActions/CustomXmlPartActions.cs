...
namespace SpreadsheetControl_WPF_API_Part02
{
    ...
    {
        public static Action<IWorkbook> StoreCustomXmlPartAction = StoreCustomXmlPart;
        public static Action<IWorkbook> ObtainCustomXmlPartAction = ObtainCustomXmlPart;
        public static Action<IWorkbook> ModifyCustomXmlPartAction = ModifyCustomXmlPart;
        ...
        static void StoreCustomXmlPart(IWorkbook workbook)
        {
            ...
            System.Diagnostics.Process.Start(new System.Diagnostics.ProcessStartInfo("Documents\\CustomXmlTest.xlsx.zip") { UseShellExecute = true }) ;
