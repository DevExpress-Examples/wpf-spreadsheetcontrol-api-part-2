...
namespace SpreadsheetControl_API_Part02
{
    public static class DataValidationActions {

        #region #Actions
        public static Action<IWorkbook> AddDataValidationAction = AddDataValidation;
        public static Action<IWorkbook> ChangeCriteriaAction = ChangeCriteria;
        public static Action<IWorkbook> ShowInputMessageAction = ShowInputMessage;
        public static Action<IWorkbook> UseUnionRangeAction = UseUnionRange;
        public static Action<IWorkbook> ShowErrorMessageAction = ShowErrorMessage;
        public static Action<IWorkbook> GetDataValidationAction = GetDataValidation;
        public static Action<IWorkbook> RemoveDataValidationAction = RemoveDataValidation;
        public static Action<IWorkbook> RemoveAllDataValidationsAction = RemoveAllDataValidations;
        #endregion #Actions
