...
'#Region "#insertshape"
            Dim imageStream As Stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("SpreadsheetControl_WPF_API_Part02.Pictures.chart.png")
...
'#Region "#modifyshape"
            ...
            Try
                ...
                Dim pic As Picture = worksheet.Shapes.AddPicture("Pictures\chart.png", worksheet.Cells("A1"))
